...
| 1    | usage error — includes a refused credential-shaped or verbosity flag, and an unusable or reused `--evidence-out` directory caught by the per-run **reservation before anything is sent** (`--evidence-out` is a directory; the tool names an immutable per-run file inside it — there is no `--overwrite`)                                                                                                                                                                                                                                                                                                                                                                                                     |
