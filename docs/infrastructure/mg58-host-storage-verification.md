...
| Ticket    | Relationship                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **MG-53** | **MG-58 lands FIRST.** MG-53 creates the Cosmos shared-throughput destination database and containers (create-only; the cutover is a separate ticket, MG-62). Running either while the host storage-plane identity is broken makes any cutover failure ambiguous between the two causes.                                                                                                                                     |
