...
4. **If ANY AC is unmet, the ticket stays open.** Finish the work. If it was already (wrongly) closed, **reopen it** — `forge backlog move <id> story`, then strip the stale `closed:` / `closed_commit:` frontmatter the move leaves behind — and complete it.
